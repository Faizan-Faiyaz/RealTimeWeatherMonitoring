...
def pred():
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=6bcd1ee1d2972a3bc60c58042b589110'
    ...
    API_KEY = 'AIzaSyCpqf2z_F4jqC9ny0CHJy6JBbGPBJmm0FI'
    SEARCH_ENGINE_ID = 'f1bfbbfbfbcd44e00'
...
# Twilio credentials
account_sid = 'AC0eef692d26b076b75a8db1aa30c84a4f'
auth_token = '465e7b29bd523e81994e19a07e91817f'
client = Client(account_sid, auth_token)
twilio_phone_number = '+14065718362'
def send_report_message(message):
    # Send SMS
    client.messages.create(to="+918709155240", from_=twilio_phone_number, body=message)
